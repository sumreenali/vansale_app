...
class PurchaseInvoiceView extends Component {
  state = {
    datum: [],
    from: "",
    to: "",
  ...
  render() {
    const { invoiceData, vansalesData } = this.props
    const data = invoiceData ? invoiceData.package.data : []
...
export default connect(mapStateToProps)(PurchaseInvoiceView)